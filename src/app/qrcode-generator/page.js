'use client' // You might not need this line
            ...
            <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center gap-10 p-10">
                <div className='flex items-center'>
                    <div className="flex flex-col space-y-10 p-4">
                        ...
                        <p className="text-gray-400 text-md md:text-lg lg:text-xl">Your QR Code will be generated automatically</p>
                ...
                {/* QR Code generated here conditionally */}
                {showQR && (
